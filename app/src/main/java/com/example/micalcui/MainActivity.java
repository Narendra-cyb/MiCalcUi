...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    MaterialButton buttonC,buttonOpenBracl,buttonCloseBrac;
    MaterialButton buttonDivide,buttonMultiply,buttonAdd,buttonSub,buttonEqals;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignId(buttonEqals,R.id.equal);
